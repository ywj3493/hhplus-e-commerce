...
**As a** 고객
**I want to** 장바구니의 상품으로 주문을 생성하고 싶다
**So that** 결제를 진행할 수 있다

#### 인수 조건 (Acceptance Criteria)

**정상 케이스:**
- [ ] **Given** 장바구니 항목 ID 목록을 입력할 때, **When** 주문 생성 요청 시, **Then** 주문이 생성되고 주문 ID를 받는다
- [ ] **Given** 주문 생성 시, **Then** 장바구니 항목 유효성이 검증된다
...
**에러 케이스:**
- [ ] **Given** 장바구니 항목 ID 목록이 비어있을 때, **When** 주문 생성 요청 시, **Then** "주문할 상품을 선택해주세요" (400 Bad Request)
- [ ] **Given** 존재하지 않는 장바구니 항목 ID일 때, **When** 주문 생성 요청 시, **Then** "장바구니 항목을 찾을 수 없습니다" (404 Not Found)
- [ ] **Given** 다른 사용자의 장바구니 항목일 때, **When** 주문 생성 요청 시, **Then** "권한이 없습니다" (403 Forbidden)
